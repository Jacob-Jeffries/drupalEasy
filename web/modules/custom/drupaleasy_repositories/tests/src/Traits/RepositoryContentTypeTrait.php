...
trait RepositoryContentTypeTrait {
  ...
  protected function createRepositoryContentType(): void {
    ...
    // Field storage config is the backend settings.
    // Field storage can only be shared between like entity types.
    ...
    // The Field Config is the instance of the
    // field attached to a node or bundle.
    FieldConfig::create([
      'field_name' => 'field_description',
      'entity_type' => 'node',
      'bundle' => 'repository',
